...
dist2['pow_prim_rtg'] = (False, 'You are close enough to the Sun to exploit its energy') 
...
dist3['pow_prim_rtg'] = (False, 'You are close enough to the Sun to exploit its energy')
